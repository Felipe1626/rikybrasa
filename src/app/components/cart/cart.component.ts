...
import { WaCloudApiService } from 'src/app/services/wa-cloud-api.service';
import { Parameter } from 'src/app/wa-cloud/wa/interfaces/purchase-confimation.interface';
...
export class CartComponent implements OnInit {
  ...
  constructor (private cartService: CartService, private WACloudService: WaCloudApiService) { }
